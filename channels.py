...
Channel(6, CATEGORY_DR).add_urls(
    best   = 'rtmp://livetv.gss.dr.dk/live/livedr06astream3',
...
Channel(100, CATEGORY_TV2_REG).add_urls(
    high   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2fyn_1000')
# TV2 Lorry
Channel(101, CATEGORY_TV2_REG).add_urls(
    best   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2lorry_2000',
    high   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2lorry_1000',
    medium = 'rtmp://80.63.11.91:1935/live/_definst_/tv2lorry_300')
# Lorry+
Channel(102, CATEGORY_TV2_REG).add_urls(
    ...
    medium = 'rtmp://80.63.11.91:1935/live/_definst_/tv2lorry-plus_300')
# TV2 Midtvest
Channel(103, CATEGORY_TV2_REG).add_urls(
    high   = 'http://ms1.tvmidtvest.dk/frokosttv')
# TV2 Nord
Channel(104, CATEGORY_TV2_REG).add_urls(
    best   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord_2000',
    high   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord_1000',
    medium = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord_300')
# TV2 NordPlus
Channel(105, CATEGORY_TV2_REG).add_urls(
    best   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord-plus_2000',
    high   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord-plus_1000',
    medium = 'rtmp://80.63.11.91:1935/live/_definst_/tv2nord-plus_300')
# TV2 East
...
Channel(108, CATEGORY_TV2_REG).add_urls(
    best   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2oj_2000',
    high   = 'rtmp://80.63.11.91:1935/live/_definst_/tv2oj_1000',
    medium = 'rtmp://80.63.11.91:1935/live/_definst_/tv2oj_300')
...
Channel(201, CATEGORY_MISC).add_urls(
    best   = 'rtmp://ftflash.arkena.dk/webtvftlivefl/ playpath=mp4:live.mp4 pageUrl=http://www.ft.dk/webTV/TV_kanalen_folketinget.aspx')
